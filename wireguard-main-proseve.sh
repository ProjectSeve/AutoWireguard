...
function installQuestions() {
    ...
    echo ""
    echo ""
    echo "Don't Change any of the settings.. the Settings is already Given so Enter only." | lolcat -a -d 5
...
function manageMenu() {
    ...
    echo "░░ ░░ ▄█ ██▄ ▀▄▀ ██▄░░ ░░" | lolcat -a -d 5
	echo ""
	echo " What do you want to do?" | lolcat -a -d 5
	echo "   1) Add a new user" | lolcat -a -d 5
	echo "   2) Revoke existing user" | lolcat -a -d 5
	echo "   3) Uninstall WireGuard" | lolcat -a -d 5
	echo "   4) Exit" | lolcat -a -d 5
